  ...
  return (
    ...
    grabCursor={true} loop={true} breakpoints={{
      ...
      return (
        ...
        className='mt-[2rem] border-b-[0.625rem] rounded-[1.25rem] 
        ...
        >
          ...
          {/* card */}
            ...
            person name, img & position */}
              <img className='rounded-xl' src={imgporto} alt=''/>
          <div className='px-[1.25rem]'>
              <div className='flex gap-4 mt-[1rem] items-center justify-center'>
